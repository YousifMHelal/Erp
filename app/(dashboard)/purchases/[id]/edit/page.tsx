...
// Static stand-in for the purchase being edited — Phase 2 has no backend, so the invoice
// this route edits is the same fixture used by /purchases/[id]. Real fetch-by-id lands with P5-5.
...
export default function EditPurchasePage() {
  ...
  return (
    <div className="flex min-h-[calc(100dvh-9.5rem)] flex-col">
      <PageHeader
        title={t("titleEditPurchase", { number: INITIAL_INVOICE.number })}
        breadcrumbs={[
